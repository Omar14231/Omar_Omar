...
// قراءة التوكن تلقائياً من الـ Key والـ Value في موقع Render
...
// دالة لتنسيق الأرقام بفاصلة
const formatNumber = (num) => Number(num).toLocaleString();

// دالة تنسيق الوقت لـ 30 يوم قادم
...
client.once('ready', async () => {
    ...
    try {
        ...
        console.log("🚀 تم رفع تحديثات أوامر الـ Slash Commands بنجاح!");
    } catch (error) {
            ...
            try {
                ...
                if (logChan) {
                    await logChan.send(
                        ...
                        `💰 **المبلغ المترتب عليه:** ${formatNumber(loan.amount)} كريدت\n` +
